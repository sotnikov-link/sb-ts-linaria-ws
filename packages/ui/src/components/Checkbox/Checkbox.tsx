 ...
 *
 * Чекбокс допускает три состояния: выбранный, невыбранный и неопределенный.
 * Последнее состояние вступает в действие, когда основной список параметров
 * содержит подсписок параметров, некоторые из которых выбраны, а некоторые —
 * нет.
 *
 * Пользователь может выбрать чекбокс, кликнув непосредственно по полю
 * или нажав на его текстовый ярлык.
 */
